...
public:
    ...
    void setAccBias(const uint8_t i, const float v) { if (i < 3) accelBias[i] = v; }
    void setGyroBias(const uint8_t i, const float v) { if (i < 3) gyroBias[i] = v; }
    void setMagBias(const uint8_t i, const float v) { if (i < 3) magBias[i] = v; }
    void setMagScale(const uint8_t i, const float v) { if (i < 3) magScale[i] = v; }
